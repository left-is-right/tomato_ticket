...
from decimal import *
from server.DataProcessServer import dataProcessKfServer
...
def mainGUI():
    ...
    def startCalc():
        ...
        status = dataProcessKfServer(ori_data, output_file, weight_coe, price_coe)
        if status == 0:
